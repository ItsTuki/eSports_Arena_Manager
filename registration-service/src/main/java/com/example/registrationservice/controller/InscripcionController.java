...
public class InscripcionController {
    ...
    @GetMapping("/torneo/{torneoId}") public List<Inscripcion> listarPorTorneo(@PathVariable Long torneoId) { return service.listar(torneoId, null, null); }
    ...
    @DeleteMapping("/{id}/cancelar") public Inscripcion cancelarDelete(@PathVariable Long id) { return service.cancelar(id); }
}
